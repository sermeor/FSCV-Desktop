...
class GRAPH_CONFIG:
    def __init__(self, parent_class):
        ...
        self.upper_bound_input = self.parent_class.gui_methods.get_input_object(self.main_frame, 'Upper bound', 'white', [1,0,1,1,0,0], [1,1,1,1,0,0], self.parent_class.fscv_data.color_upper_bound)
        self.lower_bound_input = self.parent_class.gui_methods.get_input_object(self.main_frame, 'Lower bound', 'white', [2,0,1,1,0,0], [2,1,1,1,0,0], self.parent_class.fscv_data.color_lower_bound)
